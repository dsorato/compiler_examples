...
#line 137 "parser.cpp" /* yacc.c:355  */
};
...
{
       0,    54,    54,    57,    58,    59,    62,    63,    64,    65,
      69,    70,    71,    72,    73,    76,    77,    80,    81
};
#endif
...
{
  "$end", "error", "$undefined", "T_INT", "T_DOUBLE", "T_PLUS", "T_NL",
  "T_COMMA", "T_ASSIGN", "T_ID", "T_TINT", "T_TDOUBLE", "T_TIMES",
  "$accept", "program", "lines", "line", "expr", "varlist", "vartype", YY_NULLPTR
};
#endif
...
{
       9,    -7,    -7,    -7,    -6,    -7,    -7,     5,     0,    -7,
       2,     8,    18,    -7,    23,    -7,    18,    -7,    18,    -7,
      19,    -7,    11,    -7,    20,    -7,    -7,    22,    -7
};
...
{
       0,    10,    11,     6,    12,    17,    18,     0,     0,     3,
       0,     0,     0,     1,     0,     4,     0,     7,     0,    15,
       0,    12,     9,     5,    13,    14,     8,     0,    16
};
...
{
      -2,    14,    12,     1,     2,    13,     3,    16,    17,     4,
       5,     6,     1,     2,    18,     3,    16,    19,     4,     5,
       6,     1,     2,    18,    22,    26,    27,    21,    24,    23,
      25,    28,    18,    15
};
...
{
       0,     1,     8,     3,     4,     0,     6,     5,     6,     9,
      10,    11,     3,     4,    12,     6,     5,     9,     9,    10,
      11,     3,     4,    12,    12,     6,     7,     9,    16,     6,
      18,     9,    12,     8
};
...
{
       0,     3,     4,     6,     9,    10,    11,    14,    15,    16,
      17,    19,     8,     0,     1,    16,     5,     6,    12,     9,
      18,     9,    17,     6,    17,    17,     6,     7,     9
};
...
#line 64 "parser.y" /* yacc.c:1646  */
    { symtab.defineSymbolType(((AST::Variable*)(yyvsp[-1].node))->id, (yyvsp[-2].vartype)); (yyval.node) = (yyvsp[-1].node); }
...
#line 70 "parser.y" /* yacc.c:1646  */
    {(yyval.node) = new AST::Double((yyvsp[0].doubleval));}
